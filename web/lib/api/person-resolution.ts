...
export type PersonBusinessImpact = { editions: Array<{ edition_id: string; work_id: string; title: string; edition_label: string; roles: Array<{ name: string; role: string; role_label: string; approved: boolean }>; publication: { detail: string; public_url: string }; editor_url: string; publication_url: string }>; events: Array<{ id: string; status: string; status_label: string; title: string; inspect_url: string; error_code: string; deliveries: Array<{ label: string; status: string; source_revision: number }> }> };
export type PersonPreview = Omit<components["schemas"]["PersonMergePreviewResponse"], "business_impact"> & { business_impact?: PersonBusinessImpact };
export type PersonMerge = Omit<components["schemas"]["PersonMergeRecord"], "business_impact"> & { business_impact?: PersonBusinessImpact; source_name?: string; target_name?: string };
