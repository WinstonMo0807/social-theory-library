...
export default defineConfig({
  testDir: "./tests", testMatch: "cataloging-session-v305.spec.ts",
  ...
  webServer: [
    ...
    },
    {
      ...
      env: { INTERNAL_API_URL: "http://127.0.0.1:8105/api", ALLOW_DEMO_FALLBACK: "false", NO_PROXY: "127.0.0.1,localhost" },
    },
  ],
});
