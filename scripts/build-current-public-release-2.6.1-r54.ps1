...
$stageRoot = Join-Path $releaseRoot "_stage_current_2.6.1_r54_20260815"
$archiveName = "social-theory-library-current-2.6.1-20260815-r54.tar.gz"
$archivePath = Join-Path $releaseRoot $archiveName
$archiveHashPath = "$archivePath.sha256"
$deployArtifactRoot = Join-Path $projectRoot ".codex-deploy-temp\public-deploy-20260815-r54"
