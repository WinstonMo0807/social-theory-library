...
from catalog.contracts.projections import FIELD_PROJECTION_DEPENDENCIES, field_projection_impact
...
def projection_types_for(
    ...
    if normalized_fields and field_map:
        ...
        for raw_field in normalized_fields:
            projections = field_projection_impact(normalized, raw_field)
