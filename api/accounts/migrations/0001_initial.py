    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', '管理员'), ('editor', '编辑'), ('reader', '读者')], default='reader', max_length=16, verbose_name='角色')),
                ('email_verified_at', models.DateTimeField(blank=True, null=True, verbose_name='邮箱验证时间')),
                ('locale', models.CharField(default='zh-CN', max_length=16, verbose_name='界面语言')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommendation_seed', models.CharField(blank=True, max_length=64)),
