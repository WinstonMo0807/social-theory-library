...
2026-09-21补充：下文为3.0.6上架服务基线。3.0.7保留这些数据、人工锁、发布资格及文件版本服务，界面改为最多五份本地上传、四分区馆藏工作页和逐项待办；计划推荐复用无PDF编目会话，明确关联准确出版版本后才开放馆藏链接。详见[3.0.7交付](V3.0.7_COMPLETION_RELEASE.md)，最新源码尚未公网切换。
