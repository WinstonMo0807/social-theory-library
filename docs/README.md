...
2. [上架与发布过程](INGESTION_AND_PUBLICATION.md)，理解真实保存、复核、发布、撤回、正文和任务状态。
3. [重设计任务说明](REDESIGN_BRIEF.md)，明确用户下一步要解决的问题和需要讨论的决策。
4. [当前状态](CURRENT_STATE.md)，查看最近上线证据与保留限制。
5. [根目录当前进度](../CURRENT_PROGRESS.md)，核对最新Git与正在进行的动作。
...
| [UI_3.0.5](UI_3.0.5.md) | 当前共享组件、CSS分层和具体UI验证 |
