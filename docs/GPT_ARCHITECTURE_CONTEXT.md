...
2026-09-21补充：下文为3.0.6架构与运行基线。当前工作区正实施3.0.7，导航、策展模型、预览与队列已有增量，实际公网尚未切换。请同时读取[当前状态](CURRENT_STATE.md)和[3.0.7交付](V3.0.7_COMPLETION_RELEASE.md)，不要把下文六组菜单、43入口作为本轮新增源码的完整描述。
